...
#define ThermistorPinDown A0            // Lower thermistor pin
#define ThermistorPinUp A1              // Upper thermistor pin
...
void getTemperatures() {
  tempUp = Thermistor(analogRead(ThermistorPinUp));
  tempDown = Thermistor(analogRead(ThermistorPinDown));
}
