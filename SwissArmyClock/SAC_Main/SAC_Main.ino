/**
  ...
  * - A2  :
  * - A3  : MUX SIGNAL
  * - A4  : Wire library, SDA (data)
  * - A5  : Wire library, SCL (clock)
  */
...
// Arduino Pins
const int JOY_SEL = 4;
const int PWR_TRANSISTOR_PIN = 2;
 ...
 */
 ...
 void setup()
 {
   ...
   Serial.begin(9600);
#endif // DEBUG
   DebugLn("SETUP MASTER");

   RTC.begin();
   //bmp.begin();
   
   DebugLn("Power On");
   pinMode(PWR_TRANSISTOR_PIN, OUTPUT);
   digitalWrite(PWR_TRANSISTOR_PIN, HIGH);
   mux_setup();
