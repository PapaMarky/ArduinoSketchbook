/**
  ...
  * - D1  : Serial Out
  * - D2  : LCD_CLOCK = Yellow
  * + D3  : TLC5940 - GSCLK (Purple)
  * - D4  : LCD_LATCH = Green
  * + D5  : LCD_DATA = Blue
  * + D6  :
  * - D7  : 
  * - D8  :
  * + D9  : TLC5940 - XLAT  (Yellow)
  * + D10 : TLC5940 - BLANK (Blue)
  * + D11 : TLC5940 - SIN   (Orange)
  * - D12 :
  * - D13 : TLC5940 - SCLK  (Green)
  *
  * - A1  :
  * - A2  :
  * - A3  :
  * - A4  : Wire (I2C) library, SDA (data - Yellow)
  * - A5  : Wire (I2C) library, SCL (clock - Green)
  */
  // LIBRARIES: c:/Users/mark/Downloads/arduino-1.0.1-windows/arduino-1.0.1/
...
// Pin outs from 3rd TLC
const int COLON2 = 32;    // 0
const int COLON1 = 33;    // 1

const int LCD_Red = 34;   // 2
const int LCD_Green = 35; // 3
const int LCD_Blue = 36;  // 4
